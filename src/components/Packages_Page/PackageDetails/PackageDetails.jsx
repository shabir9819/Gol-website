      ...
      <section className="package__details w-full flex flex-col lg:flex-row px-4 md:px-10  ">
        <div className="leftsection flex-1 flex flex-col pr-2 md:pr-[135px]">
          <ul className="package__details-heading flex flex-row flex-wrap w-full mb-[24px] rounded-[5px]">
            <li className="flex-1 px-2 md:px-4 py-3 text-[12px] md:text-[16px] text-[#3A3A3A] leading-[22px] uppercase font-semibold relative ">
              overview{" "}
              <span className="absolute bottom-0 left-0 w-full h-[5px] bg-[#3282AD] rounded-[8px]" />
            </li>
            <li className="flex-1 px-2 md:px-4 py-3 text-[12px] md:text-[16px] leading-[22px] uppercase font-semibold">
              itinerary
            </li>
            <li className="flex-1 px-2 md:px-4 py-3 text-[12px] md:text-[16px] leading-[22px] uppercase font-semibold">
              additional info
          ...
          <div className="package_details-desc pb-10 mb-12 border-b-2 border-b-[#A2A8AB]">
            ...
            <p className="text-[16px] text-[#5A5A5A] leading-[24px] font-normal mb-8">
              ...
              basketball courts. It offers a marine biology centre, an art
              ...
              provides classes like anti-gravity yoga, Zumba, aqua-bike classes
              and POUND® fitness lessons. Guests can hire bikes or electric
              scooters. Guests can choose among the 10 restaurants and bars the
              property offers. Sea Dragon serves authentic Chinese cuisine while
              Forbidden Bar plays live music in the night. Start the day at
              Aroma with fresh beverages and baked goods.
            </p>
          ...
          <div className="rightsection__customerDetails ">
            ...
            <div className="bottomSection px-[28px] py-[24px] mb-[48px]">
              {customer__inputSection.map((inputSection, _) => {
                return (
                  <div className="w-full flex flex-col mb-[22px]" key={inputSection.id}>
                    <label
              ...
              <div className="bottomSection__contactDetails relative">
                <div className="w-full relative mb-[16px]">
                  ...
                  <span className="w-[65%] h-[2px] absolute bottom-1/2 right-4 bg-[#A2A8AB] rounded-full"></span>
                </div>
                  ...
                  <div className="phoneSection w-full flex flex-row justify-between mb-[32px]">
                    <div className="inputSection w-[20%] h-[42px]  relative flex items-center justify-center text-center mb-[16px]">
                      <input
                        ...
                        name="clientEmail"
                        id="clientEmail"
                        className="absolute text-[16px] leading-[22px]  pr-1 w-full h-full bg-transparent border-none outline-none  "
                        value="+91"
                        readOnly
                        required
                      />
